...
//        System.out.println(list.contains(1)); - //false
        ...
        System.out.println(list.indexOf("butter")); //find the first occ of element in list
        System.out.println(list.lastIndexOf("cheeze")); //find the first occ of element in list
